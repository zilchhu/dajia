    ...
    public static async Task BuildTable2()
    {
      ...
      foreach (var v in data)
      {
        ...
        row.Append(
          ...
          v?.Cost_Ratio != null ? new Cell { CellReference = $"P{dataIndex}", DataType = CellValues.Number, CellValue = new CellValue((double)v?.Cost_Ratio) } : null,
          v?.Cost_Sum_Ratio != null ? new Cell { CellReference = $"Q{dataIndex}", DataType = CellValues.Number, CellValue = new CellValue((double)v?.Cost_Sum_Ratio) } : null,
          ...
          v?.Consume_Ratio != null ? new Cell { CellReference = $"U{dataIndex}", DataType = CellValues.Number, CellValue = new CellValue((double)v?.Consume_Ratio) } : null,
          v?.Consume_Sum_Ratio != null ? new Cell { CellReference = $"V{dataIndex}", DataType = CellValues.Number, CellValue = new CellValue((double)v?.Consume_Sum_Ratio) } : null,
          v?.Settlea_30 != null ? new Cell { CellReference = $"W{dataIndex}", DataType = CellValues.Number, CellValue = new CellValue((double)v?.Settlea_30) } : null,
          v?.Settlea_1 != null ? new Cell { CellReference = $"X{dataIndex}", DataType = CellValues.Number, CellValue = new CellValue((double)v?.Settlea_1) } : null,
          v?.Settlea_7 != null ? new Cell { CellReference = $"Y{dataIndex}", DataType = CellValues.Number, CellValue = new CellValue((double)v?.Settlea_7) } : null,
          v?.Settlea_7_3 != null ? new Cell { CellReference = $"Z{dataIndex}", DataType = CellValues.Number, CellValue = new CellValue((double)v?.Settlea_7_3) } : null,
